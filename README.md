...
>[!NOTE]
      - MegaCZT is hard coded to only update folders named mod.czt currently.<br> This is due to my tool dynamically changing the folder name to the files url extension, and not the actual folder name. which is annoying.
